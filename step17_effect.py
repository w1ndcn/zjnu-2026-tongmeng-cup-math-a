...
步骤十七：接驳车效果反馈评价
=============================
计算微公交系统对电动车需求、路网压力、TTT 和冲突风险的改善效果。

输入:
  - output_step3/baseline.txt
  - output_step11/final_capacity.csv, capacity_report.txt
  - output_step16/bus_schedule.csv

输出:
  - output_step17/bus_effect_evaluation.csv
  - output_step17/bus_effect_report.txt
"""
...
# ═══════════════════ 参数 ═══════════════════
ETA = 0.10           # 基准情景：基础替代率 10%
BUS_PCU = 1.5        # 接驳车 PCU 等效系数
...
# 早高峰 bus 替代量按建筑容量比例分配到各区域
# 从 step2 的建筑容量自动计算区域总容量
BUILDING_CAP = {
    'T_16': 3000, 'T_25': 2000,
